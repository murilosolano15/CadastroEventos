...
class Evento{
    ...
    */
    ...
    public function cadastro(){
        $query = "insert into tbeventos set tituloevento=:t,atracao=:a,descricao=:d,censura=:c,endereco=:e, lotacao=:l, dataevento=:de,hora=:h";
        ...
        */
        ...
        $stmt->bindParam("de",$this->dataevento);
